      ...
      <main className="flex-grow container mx-auto px-4 py-6 md:py-16 mt-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-5 md:mb-8">
            <Link to="/">
              <Button variant="homeButton" size="lg" className="flex items-center gap-2 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 w-full md:w-auto justify-center py-5 md:py-4 text-sm">
          ...
          <Card className="shadow-xl border-t-4 border-event-blue mb-6 md:mb-8 overflow-hidden">
            ...
            <CardContent className="flex flex-col items-center space-y-5 md:space-y-8 p-4 md:p-8">
              ...
              <div className="bg-blue-50 p-3 md:p-6 rounded-lg w-full text-xs md:text-sm border border-blue-100">
                ...
                <ol className="list-decimal pl-4 md:pl-5 space-y-1 md:space-y-3 text-gray-700 text-xs md:text-sm">
