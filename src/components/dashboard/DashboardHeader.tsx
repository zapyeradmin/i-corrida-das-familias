    ...
    <header className="bg-gradient-to-r from-event-blue-dark to-event-blue text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-brand-light">Corrida das Famílias 2025 - Gerenciamento de Inscrições</p>
        </div>
        <div className="flex items-center space-x-4">
          <div className="px-3 py-2 bg-brand-primary bg-opacity-50 rounded-md">
          ...
          <Button 
            variant="outline" 
            onClick={signOut}
            className="bg-white text-brand-primary hover:bg-brand-light border-none"
          >
            Sair
          </Button>
        </div>
