...
const EventInfoCard: React.FC = () => {
  return (
    <Card className="mt-6 overflow-hidden border-t-4 border-brand-primary shadow-lg bg-white/90 backdrop-blur-sm hover:shadow-xl transition-shadow">
      ...
      <CardContent className="space-y-6 p-6">
        <div className="aspect-w-16 aspect-h-9">
          <AspectRatio ratio={16 / 9} className="bg-muted rounded-md overflow-hidden shadow-inner">
            <img 
              src="/lovable-uploads/1cde5e5e-1231-4c34-abdb-7cadc7910baf.png" 
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="flex flex-col items-center p-4 bg-brand-light rounded-lg shadow-sm">
            <Calendar className="h-8 w-8 text-brand-primary mb-2" />
            <h4 className="font-medium text-gray-700">Data do Evento</h4>
            <p className="text-gray-900 font-semibold text-center">15 de Junho de 2025</p>
          </div>
          
          <div className="flex flex-col items-center p-4 bg-brand-light rounded-lg shadow-sm">
            <MapPin className="h-8 w-8 text-brand-primary mb-2" />
            <h4 className="font-medium text-gray-700">Local</h4>
            <p className="text-gray-900 font-semibold text-center">Igreja Matriz do Rosário, Serra Talhada</p>
          </div>
          
          <div className="flex flex-col items-center p-4 bg-brand-light rounded-lg shadow-sm">
            <Clock className="h-8 w-8 text-brand-primary mb-2" />
            <h4 className="font-medium text-gray-700">Horário</h4>
            <p className="text-gray-900 font-semibold text-center">5:00 - Concentração</p>
            <p className="text-gray-900 font-semibold text-center">6:00 - Largada</p>
          </div>
        </div>
      </CardContent>
    </Card>
