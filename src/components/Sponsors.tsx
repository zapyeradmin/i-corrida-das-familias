    ...
    <section id="sponsors" className="pt-20 md:pt-28 pb-16 md:pb-20 bg-gray-100 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <SwiperSlide key={sponsor.id}>
                <div className="h-40 flex items-center justify-center">
                  <img 
                    ...
                    className="max-h-28 max-w-52 object-contain transition-transform hover:scale-105" 
                  />
                </div>
              </SwiperSlide>
            ))}
        ...
        <div className="text-center">
          ...
          <a 
            href="https://wa.me/5587996709355" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-block bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3 px-8 rounded-lg text-lg cta-button shadow-lg"
          >
