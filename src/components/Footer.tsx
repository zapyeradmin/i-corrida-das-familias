      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#about" className="hover:text-event-orange transition-colors">
                  Sobre o Evento
                </a>
              </li>
              <li>
                <a href="#timeline" className="hover:text-event-orange transition-colors">
                  Cronograma
                </a>
              </li>
              <li>
                <a href="#course" className="hover:text-event-orange transition-colors">
                  Percurso
                </a>
              </li>
              <li>
                <a href="#registration" className="hover:text-event-orange transition-colors">
                  Inscreva-se
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                aria-label="Facebook" 
                className="text-gray-400 hover:text-event-orange transition-colors"
              >
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm">
          <p>
            ...
            Desenvolvido com 
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 inline mx-1 text-event-orange" fill="currentColor" viewBox="0 0 24 24">
